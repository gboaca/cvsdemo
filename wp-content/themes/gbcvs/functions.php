...
/////////////////////////////////////////////////
// enqueue styles for custom post formats
/////////////////////////////////////////////////
function sg_frontend_enqueue_styles(){
    ...
    if( ( get_post_type() == 'cv' ) && is_page_template( 'single-cv.php' ) ) {

        wp_register_style('cvcss', get_template_directory_uri() . '/cv-style.css', array(), '1.0.0', false);
    	wp_enqueue_style( 'cvcss', get_template_directory_uri() . '/cv-style.css' );
    }

    if( ( get_post_type() == 'cv' ) && is_page_template( 'single-cv2.php' ) ) {

    	 wp_register_style('cvcss', get_template_directory_uri() . '/cv-style.css', array(), '1.0.0', false);
    	wp_enqueue_style( 'cvcss', get_template_directory_uri() . '/cv-style.css' );

        wp_register_style('icons', get_template_directory_uri() . '/ramirez-template/vendors/material-icon/css/materialdesignicons.min.css', array(), '1.0.0', false);
    	wp_enqueue_style( 'icons', get_template_directory_uri() . '/ramirez-template/vendors/material-icon/css/materialdesignicons.min.css' );

    	wp_register_style('fa', get_template_directory_uri() . '/ramirez-template/css/font-awesome.min.css', array(), '1.0.0', false);
    	wp_enqueue_style( 'fa', get_template_directory_uri() . '/ramirez-template/css/font-awesome.min.css' );
...
add_action('wp_enqueue_scripts', 'sg_frontend_enqueue_styles');
...
function my_remove_menu_pages() {
  ...
  remove_menu_page( 'cptui_main_menu' );	//https://boaca.ro/apps/cvsdemo/wp-admin/admin.php?page=cptui_manage_post_types
};
...
function auto_login() {
	...
	$loginpageid   = '78'; //Page ID of your login page
	$loginusername = 'cvsdemo'; //username of the WordPress user account to impersonate
